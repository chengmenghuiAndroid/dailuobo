...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param color     分割线颜色
     */
    public GridDividerItemDecoration(Context context, int dividerWidth, boolean isNeedSpace, @ColorInt int color) {
        this(context, dividerWidth, 0, isNeedSpace, false, color);
    }
